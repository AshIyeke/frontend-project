          ...
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 mb-6 shadow-lg">
              ...
              <span className="text-sm font-medium text-gray-800">
                Find exclusive deals in <span className="font-bold">120+</span> countries
              </span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-2xl leading-relaxed">
              Discover luxury escapes, boutique stays, and unforgettable destinations
              worldwide. Book your perfect stay with ease and style
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/search"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-200 shadow-xl hover:shadow-2xl hover:scale-105"
              >
                Find Your Stay
              </Link>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-12 pt-8 border-t border-white/20">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/90 text-sm font-medium">Verified Properties</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/90 text-sm font-medium">Secure Booking</span>
              </div>
            </div>
          </div>
        </div>
