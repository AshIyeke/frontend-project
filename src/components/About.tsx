    ...
    <div className="bg-white dark:bg-gray-900 text-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-white leading-relaxed mb-4">
              Nestled in the heart of the city, our hotel combines timeless
              luxury with modern comfort. Since our founding, we have been
              dedicated to creating unforgettable experiences for travelers from
              around the world.
            </p>
            <p className="text-gray-600  dark:text-white  leading-relaxed">
              Whether you&apos;re here for business or leisure, we promise
              warmth, elegance, and personalized service that makes you feel at
              home.
            </p>
          </div>
        </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl dark:text-white font-bold mb-12">
            Why Stay With Us?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Spacious rooms, premium bedding, and world-class amenities
            ...
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Gourmet cuisine prepared by award-winning chefs with locally
                sourced ingredients.
              </p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Unwind with our spa, pool, and wellness facilities designed to
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-gray-600   dark:text-white   max-w-3xl mx-auto leading-relaxed">
          ...
          accommodation. Our mission is to provide unmatched hospitality,
          blending luxury with comfort, and ensuring every guest leaves with
          cherished memories.
        </p>
      </section>
      ...
      <section className="bg-blue-600 py-12 text-center text-white">
        ...
        <p className="mb-6">
          Discover elegance, comfort, and unmatched hospitality today.
        </p>
        <a
          href="/contact"
