        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              ...
              decade of excellence, we&apos;ve crafted unforgettable experiences
              for travelers worldwide, combining world-class hospitality with
              cutting-edge technology.
            </p>

            <p className="text-gray-600 mb-8 leading-relaxed">
              Our carefully curated collection of hotels spans across the
              globe&apos;s most sought-after destinations. From boutique
              hideaways to grand luxury resorts, each property is handpicked to
              ensure you experience nothing but the finest accommodations,
